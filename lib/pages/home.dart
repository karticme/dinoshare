...
import 'package:dinoshare/pages/favourite.dart';
            ...
            Expanded(
              child: ValueListenableBuilder<List<TransferHistoryItem>>(
                ...
                builder: (_, history, _) {
                  ...
                  final favouriteChip =
                      ValueListenableBuilder<List<FavouriteDevice>>(
                        valueListenable: appFavouriteDevices,
                        builder: (_, favourites, child) {
                          final favouriteCount = favourites.length;
                          ...
                          return DItem(
                            ...
                            title: const Text('Favourite Devices'),
                            suffix:
                                favouriteCount == 0
                                    ? null
                                    : DText(
                              ...
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                    child: HugeIcon(
                                      icon:
                                          HugeIcons.strokeRoundedClipboardClock,
                                      size: 24,
                                      color: theme.colors.mutedForeground,
                                    ),
                                  ),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children:
                                recentToday
                                    .map(
                                      (h) => TransferHistoryGroupView(item: h),
                                    )
                                    .toList(),
                          ),
                        ),
